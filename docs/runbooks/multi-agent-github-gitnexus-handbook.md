...
```text
C:\amx\ConsultantAIP-main        main 分支和发布权威工作区
C:\amx\ConsultantAIP-codex       Codex 架构、集成、审查、发布工作区
C:\amx\ConsultantAIP-antigravity Antigravity/Gemini 实现和回归工作区
C:\amx\ConsultantAIP-claude      Claude/Agent C 验收和文档工作区
...
```powershell
git clone https://github.com/BizYan/AMX.git C:\amx\ConsultantAIP-main
...
```powershell
git clone https://github.com/BizYan/AMX.git C:\amx\ConsultantAIP-codex
git clone https://github.com/BizYan/AMX.git C:\amx\ConsultantAIP-antigravity
git clone https://github.com/BizYan/AMX.git C:\amx\ConsultantAIP-claude
```
